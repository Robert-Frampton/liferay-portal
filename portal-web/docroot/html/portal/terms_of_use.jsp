...
<aui:form action='<%= themeDisplay.getPathMain() + "/portal/update_terms_of_use" %>' name="fm">
	...
	<c:choose>
		...
		<c:otherwise>
			...
			<ol>
				<li>
					<span class="underline-bold">Acceptance of Agreement</span>.<br />
				...
				<li>
					<span class="underline-bold">Copyright</span>.<br />
				...
				<li>
					<span class="underline-bold">Service Marks</span>.<br />
				...
				<li>
					<span class="underline-bold">Limited Right to Use</span>.<br />
				...
				<li>
					<span class="underline-bold">Editing, Deleting and Modification</span>.<br />
				...
				<li>
					<span class="underline-bold">Indemnification</span>.<br />
				...
				<li>
					<span class="underline-bold">Nontransferable</span>.<br />
				...
				<li>
					<span class="underline-bold">Disclaimer and Limits</span>.<br />
				...
				<li>
					<span class="underline-bold">Use of Information asdf</span>.<br />
				...
				<li>
					<span class="underline-bold">Third-Party Services</span>.<br />
				...
				<li>
					<span class="underline-bold">Third-Party Merchant Policies</span>.<br />
				...
				<li>
					<span class="underline-bold">Privacy Policy</span>.<br />
				...
				<li>
					<span class="underline-bold">Payments</span>.<br />
				...
				<li>
					<span class="underline-bold">Securities Laws</span>.<br />
				...
				<li>
					<span class="underline-bold">Links to Other Web Sites</span>.<br />
				...
				<li>
					<span class="underline-bold">Copyrights and Copyright Agents</span>.<br />
				...
				<li>
					<span class="underline-bold">Proposed Product and Service Offerings</span>.<br />
				...
				<li>
					<span class="underline-bold">Information and Press Releases</span>.<br />
				...
				<li>
					<span class="underline-bold">Miscellaneous</span>.<br />
