...
<aui:form action='<%= themeDisplay.getPathMain() + "/portal/update_terms_of_use" %>' name="fm">
	...
	<c:choose>
		...
		<c:otherwise>
			...
			<ol>
				<li>
					<strong><span style="text-decoration: underline;">Acceptance of Agreement</span></strong>.<br />
				...
				<li>
					<strong><span style="text-decoration: underline;">Copyright</span></strong>.<br />
				...
				<li>
					<strong><span style="text-decoration: underline;">Service Marks</span></strong>.<br />
				...
				<li>
					<strong><span style="text-decoration: underline;">Limited Right to Use</span></strong>.<br />
				...
				<li>
					<strong><span style="text-decoration: underline;">Editing, Deleting and Modification</span></strong>.<br />
				...
				<li>
					<strong><span style="text-decoration: underline;">Indemnification</span></strong>.<br />
				...
				<li>
					<strong><span style="text-decoration: underline;">Nontransferable</span></strong>.<br />
				...
				<li>
					<strong><span style="text-decoration: underline;">Disclaimer and Limits</span></strong>.<br />
				...
				<li>
					<strong><span style="text-decoration: underline;">Use of Information</span></strong>.<br />
				...
				<li>
					<strong><span style="text-decoration: underline;">Third-Party Services</span></strong>.<br />
				...
				<li>
					<strong><span style="text-decoration: underline;">Third-Party Merchant Policies</span></strong>.<br />
				...
				<li>
					<strong><span style="text-decoration: underline;">Privacy Policy</span></strong>.<br />
				...
				<li>
					<strong><span style="text-decoration: underline;">Payments</span></strong>.<br />
				...
				<li>
					<strong><span style="text-decoration: underline;">Securities Laws</span></strong>.<br />
				...
				<li>
					<strong><span style="text-decoration: underline;">Links to Other Web Sites</span></strong>.<br />
				...
				<li>
					<strong><span style="text-decoration: underline;">Copyrights and Copyright Agents</span></strong>.<br />
				...
				<li>
					<strong><span style="text-decoration: underline;">Proposed Product and Service Offerings</span></strong>.<br />
				...
				<li>
					<strong><span style="text-decoration: underline;">Information and Press Releases</span></strong>.<br />
				...
				<li>
					<strong><span style="text-decoration: underline;">Miscellaneous</span></strong>.<br />
