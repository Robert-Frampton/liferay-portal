...
<aui:form action="<%= unitURL %>" cssClass="form-inline" id="fm" method="post" name="fm">
	<aui:container>
		<aui:row>
			<aui:col width="<%= 10 %>">
			...
			<aui:col width="<%= 30 %>">
				<aui:select inlineField="<%= true %>" label="" name="fromId">
					<c:if test="<%= type == 0 %>">
		...
		<aui:row>
			...
			<aui:col width="<%= 30 %>">
				<aui:select inlineField="<%= true %>" label="" name="toId">
					<c:if test="<%= type == 0 %>">
